...
def bev_from_pcl(lidar_pcl, configs):
    ...
    lidar_pcl_top = np.copy(lidar_pcl_cpy)
    idx_height = np.lexsort((-lidar_pcl_cpy[:, 2], lidar_pcl_cpy[:, 1], lidar_pcl_cpy[:, 0]))
    #idx_height = np.lexsort((-lidar_pcl_cpy[:, 3], lidar_pcl_cpy[:, 1], lidar_pcl_cpy[:, 0]))
    lidar_pcl_cpy = lidar_pcl_cpy[idx_height]

    idx_height = np.lexsort((-lidar_pcl_top[:, 2], lidar_pcl_top[:, 1], lidar_pcl_top[:, 0]))
    lidar_pcl_top = lidar_pcl_top[idx_height]

    lidar_pcl_cpy[lidar_pcl_cpy[:,3]>configs.lim_r[1],3] = configs.lim_r[1]
    ...
    lidar_pcl_cpy = lidar_pcl_cpy[idx_height_unique]
    ...
    intensity_map[np.int_(lidar_pcl_cpy[:, 0]), np.int_(lidar_pcl_cpy[:, 1])] = lidar_pcl_cpy[:, 3] / (np.amax(lidar_pcl_cpy[:, 3]) - np.amin(lidar_pcl_cpy[:, 3]))
